...
@interface OperationViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, ADKModalMaskViewDelegate>
...
- (void)setupView
{
    ...
    UIBarButtonItem *supportBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemPause
                                                                                          target:self
                                                                                          action:@selector(forcePauseScrollingHandler)];
...
- (void)forcePauseScrollingHandler
{
    [self.demoCollectionView ADKForceStopScrolling];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell) {
        ...
        avengersCell.contentView.backgroundColor = [UIColor themeCellBackgroundColor];
        avengersCell.titleLabel.textColor = [UIColor themeTitleColor];
        avengersCell.descriptionLabel.textColor = [UIColor themeSubtitleColor];
    }
