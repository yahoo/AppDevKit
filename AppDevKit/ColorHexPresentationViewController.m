//
//  UIColorHexPresentationViewController.m
//  AppDevKit
//
...
@interface ColorHexPresentationViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, ADKModalMaskViewDelegate>
...
@property (assign, nonatomic) BOOL mainThemeMode;

@end

@implementation ColorHexPresentationViewController
...
- (void)setupView
{
    self.title = @"UIColor+ADKHexPresentation";
    self.mainThemeMode = YES;
    ...
    UIBarButtonItem *supportBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemReply
                                                                                          target:self
...
{
    self.mainThemeMode = !self.mainThemeMode;

    if (self.mainThemeMode) {
        [ThemeManager setThemeMode:ThemeColorMain];
    } else {
        [ThemeManager setThemeMode:ThemeColorSub];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell) {
        ...
        avengersCell.contentView.backgroundColor = [ThemeManager themeCellBackgroundColor];
        avengersCell.titleLabel.textColor = [ThemeManager themeTitleColor];
        avengersCell.descriptionLabel.textColor = [ThemeManager themeSubtitleColor];
    }
